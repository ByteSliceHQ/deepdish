    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <div className="mx-auto max-w-4xl px-4 py-8 font-sans text-white">
        ...
        <p className="mb-6">
          ...
          an account. When creating your account, you must provide accurate and
          complete information. You are responsible for all activities that
          occur under your account and for maintaining the confidentiality of
          your account credentials. You agree to notify ByteSlice immediately of
        ...
        <div className="mb-6 space-y-3">
          ...
          <p>
            <strong>4.2 Intellectual Property Rights.</strong> All content,
            brand features, and materials made available through the Service,
            including but not limited to software, text, graphics, logos, and
            images, are owned or licensed by ByteSlice and are protected by
            applicable intellectual property laws. You may not reproduce,
            modify, distribute, or create derivative works of any portion of the
        ...
        <p className="mb-6">
          ...
          provide. By providing User Content to the Service, you grant ByteSlice
          a worldwide, non-exclusive, royalty-free license to use, copy,
          reformat, distribute, and display such User Content to the extent
          necessary to provide the Service. You represent and warrant that you
          have all the rights necessary to grant these licenses and that your
        ...
        <ul className="mb-6 list-inside list-disc space-y-1">
          <li>
            Using the Service for any unlawful, fraudulent, or malicious
            purposes.
          </li>
          <li>
          ...
          <li>
            Using the Service in any manner that could damage, disable, or
            impair ByteSlice’s servers or networks.
          </li>
          <li>
            Reverse engineering, decompiling, or disassembling the Service or
            any portion thereof.
          </li>
        </ul>
        ...
        <p className="mb-6">
          ...
          documentation or sign-up process for the Service. If you fail to pay
          any fees when due, ByteSlice reserves the right to suspend or
        ...
        <p className="mb-6">
          ...
          including business plans, product roadmaps, pricing, or other
          proprietary data, shall be maintained as confidential and not
          disclosed to any third party without the express written consent of
        ...
        <p className="mb-6">
          ...
          Terms. Upon termination, you must immediately stop using the Service.
        ...
        <p className="mb-6">
          <strong>
            ...
            PARTICULAR PURPOSE, AND NON-INFRINGEMENT. BYTESLICE MAKES NO
        ...
        <p className="mb-6">
          ...
          CONTENT OF ANY THIRD PARTY ON THE SERVICE; OR (C) UNAUTHORIZED ACCESS,
        ...
        <p className="mb-6">
          ...
          construed in accordance with the laws of the state in which ByteSlice
          is formed, without regard to its conflict of laws provisions. Any
          dispute arising out of or relating to these Terms or the Service shall
          be resolved exclusively in the courts located in that state, and you
        ...
        <div className="mb-6 space-y-3">
          <p>
            <strong>16.1 Entire Agreement.</strong> These Terms, together with
            any other agreements referenced herein, constitute the entire
            agreement between you and ByteSlice regarding the Service.
          </p>
          <p>
            <strong>16.2 No Waiver.</strong> The failure of ByteSlice to enforce
            any right or provision of these Terms shall not be deemed a waiver
            of such right or provision.
          </p>
          <p>
            <strong>16.3 Severability.</strong> If any provision of these Terms
            is held to be invalid or unenforceable, the remaining provisions
            shall remain in full force and effect.
          </p>
          <p>
            <strong>16.4 Assignment.</strong> You may not assign or transfer
