  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 font-sans">
      ...
      <div className="mb-6 space-y-3">
        ...
        <p>
          <strong>1.2 Usage Data and Metrics.</strong> We automatically collect
          usage information such as pages visited, features used, the amount of
          time spent on certain features, click data, and other metrics related
          to your interaction with the Service. This data helps us understand
          how users are engaging with DeepDish so we can improve our product and
          better serve our customers.
        </p>
        <p>
          <strong>1.3 Device Information.</strong> We may collect information
          about the device you use to access our Service, including IP address,
      ...
      <div className="mb-6 space-y-3">
        ...
        <p>
          <strong>2.3 To Communicate with You.</strong> We may use your contact
          information to respond to inquiries, provide updates, or send
          marketing and promotional communications. You can opt out of marketing
        ...
        <p>
          <strong>2.5 To Enforce Our Terms and Policies.</strong> We may use the
          collected information to investigate suspected violations of our Terms
          of Service or this Policy, or as otherwise required by law.
        </p>
      </div>
      ...
      <div className="mb-6 space-y-3">
        <p>
          ...
          with third-party vendors, consultants, or service providers who need
          access to such information to perform tasks on our behalf. These
          service providers are authorized to use your information only to
          provide services to us.
        </p>
        <p>
          <strong>3.2 Business Transfers.</strong> If ByteSlice is involved in a
          merger, acquisition, sale of assets, or other business transaction,
          your information may be transferred as part of that transaction. We
          will notify you via email or a prominent notice on our website if a
          transaction affects the processing of your personal information.
        </p>
        <p>
      ...
      <p className="mb-6">
        ...
        is required or permitted by law. Usage data and metrics may be retained
        for internal analysis; this data typically does not contain personally
        identifiable information and is retained to improve our Service’s
      ...
      <p className="mb-6">
        ...
        choose to do so, some features of the Service may not function properly.
      </p>

      <h2 className="mb-2 text-xl font-semibold">6. Data Security</h2>
      <p className="mb-6">
        We implement reasonable technical and organizational measures to protect
        your personal information from loss, theft, misuse, and unauthorized
        access or disclosure. However, no electronic transmission or storage of
        information can be guaranteed to be 100% secure. You also have a
        responsibility to maintain the confidentiality of your account and
        password.
      </p>

      <h2 className="mb-2 text-xl font-semibold">7. Children’s Privacy</h2>
      <p className="mb-6">
        The Service is not intended for use by children under the age of 13 (or
        the age of majority in your jurisdiction). We do not knowingly collect
        personal information from children. If you believe we have inadvertently
        collected such information, please contact us so we can promptly remove
        it.
      </p>

      <h2 className="mb-2 text-xl font-semibold">8. Your Rights and Choices</h2>
      <div className="mb-6 space-y-3">
        <p>
          <strong>8.1 Access and Correction.</strong> You may access and update
        ...
        <p>
          ...
          marketing-related emails by following the unsubscribe instructions in
          those communications or by contacting us. Even if you opt out of
          marketing emails, we may still send you non-promotional messages such
          as updates about your account or changes to our policies.
        </p>
        <p>
          <strong>8.3 Do Not Track.</strong> Currently, we do not respond to “Do
          Not Track” signals in browsers. You can control cookies and other
      ...
      <p className="mb-6">
        ...
        service providers are located. These countries may have data protection
        laws that are different from the laws of your country.
      </p>

      <h2 className="mb-2 text-xl font-semibold">10. Changes to This Policy</h2>
      <p className="mb-6">
        We may update this Privacy Policy to reflect changes in our practices or
        the law. If we make material changes, we will notify you by posting the
        updated Policy on our website or via email. Your continued use of the
        Service after such changes constitute your acceptance of the revised
        Policy.
      </p>
