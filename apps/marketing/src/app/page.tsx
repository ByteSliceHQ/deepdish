    ...
    <main className="flex-grow">
      ...
      <section className="py-16 sm:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <h2 className="text-3xl font-bold mb-12 text-left sm:text-center">
            Why use DeepDish?
          </h2>
      ...
      <section id="about" className="py-16 sm:py-24 bg-gray-900">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-left sm:text-center">
            About DeepDish
          </h2>
          <div className="bg-gray-800 p-8 rounded-lg shadow-lg">
            <p className="text-xl text-gray-300 mb-6">
              We were frustrated with existing CMS systems and wanted to build a
              framework that worked for development and marketing teams alike.
              DeepDish empowers both devs and content creators with a modern,
      ...
      <section id="code-example" className="py-16 sm:py-24 bg-gray-900">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-left sm:text-center">
